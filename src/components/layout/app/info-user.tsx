...
import LoginPopover from "@/app/[locale]/(site)/(homepage)/_components/login-popover/login-popover";
...
export default function InfoUser() {
    ...
    return (
        <HoverCard openDelay={100} closeDelay={40000}>
            ...
            {!token && (
                <HoverCardContent align="start" className="w-[400px] p-0 shadow-2xl rounded-lg overflow-hidden">
                    <LoginPopover />
                </HoverCardContent>
            )}
        </HoverCard>
